...
Plug 'kana/vim-textobj-user' | Plug 'kana/vim-textobj-entire' | Plug 'glts/vim-textobj-comment' | Plug 'kana/vim-textobj-indent' | Plug 'jceb/vim-textobj-uri' | Plug 'kana/vim-textobj-indent'
